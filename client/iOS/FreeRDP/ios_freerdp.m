...
//    freerdp_channels_load_plugin(instance->context->channels, instance->settings, "appshell", NULL);
...
int ios_receive_channel_data(freerdp* instance, int channelId, BYTE* data, int size, int flags, int total_size)
{
